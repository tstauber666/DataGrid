...
static bool createConnection()
{
    ...
    query.exec("create table IF NOT EXISTS artists (id integer primary key autoincrement,artist varchar(40), albumcount int)");
    ...
    query.exec("create table IF NOT EXISTS albums (albumid integer primary key autoincrement, "
                                     "title varchar(50), "
                                     "artistid int, "
                                     "year int, FOREIGN KEY (artistid) REFERENCES artists(id))");
